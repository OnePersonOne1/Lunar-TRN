...
SUMMARY = [
    ...
    ("τ YOLO FP32 (동일 벤치) [ms]", "p7c_det_compare.json",
     "entries.yolo_fp32.tau.median_s", "{:.1f}", 1e3),
    ("τ YOLO INT8 (동일 벤치) [ms]", "p7c_det_compare.json",
     "entries.yolo_int8.tau.median_s", "{:.1f}", 1e3),
